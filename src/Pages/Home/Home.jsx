...
function Home() {
  ...
  const frontendSkills = [
    ...
    { name: "JavaScript", level: 82, icon: faJs, color: "#F7DF1E" },
              ...
              <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
                ...
                <div className="relative">
                  ...
                  <p className="text-base sm:text-lg md:text-xl text-gray-300 mt-4 md:mt-6 font-mono leading-relaxed">
                    <span className="text-[#48ff00]">&gt;</span> Crafting
                ...
                <div className="bg-black/70 border border-[#48ff00]/30 p-4 sm:p-6 rounded-xl">
                  ...
                  >
                    <pre className="text-gray-300 whitespace-pre-wrap break-words">
                      ...
                      {"\n"}
                      <span className="text-cyan-400 ml-2 sm:ml-4 block sm:inline">
                  ...
                  <div className="mt-3 sm:mt-4 flex items-center">
                    <span className="text-[#48ff00] font-mono text-sm mr-1 sm:mr-2">
                      $
                    </span>
                ...
                <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                  <Link to="/projects" className="group relative px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#48ff00] to-[#00ff41] text-black font-mono font-bold rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 text-sm sm:text-base">
                  ...
                  <Link to="/contact" className="group px-4 sm:px-6 md:px-8 py-3 sm:py-4 border-2 border-[#48ff00] text-[#48ff00] font-mono font-bold rounded-lg hover:bg-[#48ff00] hover:text-black transition-all duration-300 hover:scale-105 text-sm sm:text-base">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    >
                      <FontAwesomeIcon
                        icon={stat.icon}
                        className="text-xl sm:text-2xl text-[#48ff00] mb-1 sm:mb-2"
                      />
              ...
              <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
                    ...
                    modern, responsive, and performant web applications. I
                    specialize in the React ecosystem.
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 pt-4 md:pt-6">
                  {[
                    ...
                    },
                    {
                      icon: faEnvelope,
                      label: "Email",
                      value: "rafideveloper7@gmail.com",
                    },
                    {
                      icon: faBriefcase,
                      label: "Freelance",
              ...
              <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {[
                      ...
                      },
                      {
                        ...
                        company: "GCMS College Kohat",
                      },
                    ].map((exp, index) => (
                      <div
                        key={index}
                        className="relative pl-6 sm:pl-8 pb-4 sm:pb-6 border-l border-[#48ff00]/30 last:pb-0"
                      >
                        <div className="absolute left-[-5px] sm:left-[-6px] top-0 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#48ff00] rounded-full"></div>
                        <div className="text-[#48ff00] font-mono text-xs sm:text-sm mb-1">
                          {exp.year}
                        </div>
                ...
                <div className="bg-black/30 border border-[#48ff00]/20 rounded-xl p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {[
                      {
                        degree: "Web & Mobile App",
                        school: "at SMIT - compeleted course + Intern",
                        year: "2024-2025",
                      },
                      {
                        degree: "GCMS College Kohat",
                        school: "ICS Computer",
                        year: "2024",
                      },
                      {
                        degree: "GHS Tappi Kohat",
                        school: "High School",
                        year: "2022",
                      },
                    ].map((edu, index) => (
                      <div
                        key={index}
                        className="pb-3 sm:pb-4 border-b border-[#48ff00]/10 last:border-0 last:pb-0"
                      >
                        ...
                        <div className="text-[#48ff00] text-xs sm:text-sm font-mono mt-1">
                          {edu.year}
                        </div>
                      </div>
                    ))}
              ...
              {[
                {
                  ...
                  description:
                    "Building dynamic, scalable React applications with modern best practices.",
                  features: [
                    "Custom Components",
                    "State Management",
                    "Performance",
                ...
                },
                {
                  ...
                  description:
                    "Full-stack applications with Next.js 14 App Router.",
                ...
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-lg bg-[#48ff00]/10 flex items-center justify-center mb-4 group-hover:bg-[#48ff00]/20 transition-colors flex-shrink-0">
                    <FontAwesomeIcon
                      icon={service.icon}
                      className="text-xl sm:text-2xl text-[#48ff00]"
                    />
                  </div>

                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3 truncate">
                    {service.title}
                  </h3>
        ...
        <section className="py-12 md:py-20 border-t border-[#48ff00]/10">
          <div className="w-full px-3 sm:px-4 md:px-6">
            <div className="max-w-4xl m-auto text-center">
              ...
              <Link
                to="/contact"
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 border-2 rounded-lg p-3"
              >
                Contact Me
              </Link>
            </div>
