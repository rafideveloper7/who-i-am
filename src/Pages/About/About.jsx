...
function About() {
  ...
  const personalInfo = [
    ...
    { icon: faCalendar, label: "Age", value: "18 Years" },
    { icon: faMapMarkerAlt, label: "Location", value: "Kohat, Pakistan" },
    { icon: faEnvelope, label: "Email", value: "rafideveloper7@gmail.com" },
    { icon: faPhone, label: "Phone", value: "+92 336 5091321" },
    {
      icon: faGlobe,
      label: "Languages",
      value: "English, Urdu, Hindi, Pashtoo",
    },
  ];
  ...
  const education = [
    {
      year: "2021-2023",
      degree: "HSSC",
      institution: "Govt High School Tappi Kohat",
      description: "Computer Science, operating systems, hardware",
    },
    {
      year: "2023-2025",
      degree: "Intermediate (ICS)",
      institution: "GCMS College Kohat",
      description: "Mathematics, Statistics, Computer, System Design",
    },
    {
      year: "2024-2025 Present",
      degree: "Frontend Development Certification",
      institution: "SMIT (Saylani Mass IT Training)",
      description: "React.js, JavaScript, Modern Web Development, MERN Stack",
    },
  ];
  ...
  const interests = [
    ...
    },
    {
      icon: faUsers,
      name: "Mentoring",
      description: "Helping aspiring developers",
    },
    {
      icon: faMedal,
      name: "Coding Challenges",
      description: "Solving problems on LeetCode",
    },
    {
      icon: faHeart,
      name: "UI/UX Design",
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6">
            ...
            <span className="text-[#48ff00] relative inline-block">
              <span className="glitch-effect" data-text="ME">
                ME
              </span>
            </span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto px-2 font-mono">
            <span className="text-[#48ff00]">&gt;</span> Passionate developer
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="bg-black/50 border border-[#48ff00]/30 rounded-xl p-4 sm:p-6 md:p-8">
              ...
              <p className="text-[#48ff00] text-center font-mono text-sm sm:text-base mb-4">
                Senior Frontend Developer
              </p>

              <div className="text-center mb-6">
                <p className="text-gray-400 text-sm sm:text-base mb-4">
                  Transforming ideas into interactive digital experiences with
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {personalInfo.map((info, index) => (
                      <div
                        key={index}
                        className="flex items-center p-3 sm:p-4 bg-black/30 rounded-lg border border-[#48ff00]/20"
                      >
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[#48ff00]/10 flex items-center justify-center mr-3 sm:mr-4">
                          <FontAwesomeIcon
                            icon={info.icon}
                            className="text-[#48ff00] text-lg sm:text-xl"
                          />
                        </div>
                        <div>
                          <div className="text-gray-400 text-xs sm:text-sm">
                  ...
                  <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gradient-to-r from-black/50 to-[#48ff00]/5 border border-[#48ff00]/20 rounded-lg">
                    <div className="flex items-start">
                      <FontAwesomeIcon
                        icon={faQuoteLeft}
                        className="text-[#48ff00] text-xl mr-3 mt-1"
                      />
                      <div>
                        <p className="text-gray-300 text-sm sm:text-base italic mb-3">
                          "I believe in writing clean, efficient code that not
                          only works but also tells a story. Every project is an
                          opportunity to learn, innovate, and push the
                          boundaries of what's possible on the web."
                        </p>
                        <div className="flex justify-end">
                          <FontAwesomeIcon
                            icon={faQuoteRight}
                            className="text-[#48ff00] text-xl"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {education.map((edu, index) => (
                      <div
                        key={index}
                        className="relative pl-8 sm:pl-12 pb-4 sm:pb-6 border-l border-[#48ff00]/30 last:pb-0 group"
                      >
                        ...
                        <div className="text-[#48ff00] font-mono text-sm sm:text-base mb-1">
                          {edu.year}
                        </div>
                ...
                <div>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    {experience.map((exp, index) => (
                      <div
                        key={index}
                        className="bg-black/30 border border-[#48ff00]/20 rounded-lg p-4 sm:p-6 hover:border-[#48ff00] transition-all duration-300"
                      >
                        ...
                        <ul className="space-y-2">
                          {exp.responsibilities.map((resp, idx) => (
                            ...
                            >
                              <span className="text-[#48ff00] mr-2 mt-1">
                                ▸
                              </span>
                              {resp}
                            </li>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    {skills.map((skill, index) => (
                      <div
                        key={index}
                        className="bg-black/30 border border-[#48ff00]/20 rounded-lg p-4 hover:border-[#48ff00] transition-all duration-300"
                      >
                    ...
                    {interests.map((interest, index) => (
                      ...
                      >
                        <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto rounded-lg bg-[#48ff00]/10 flex items-center justify-center mb-3">
                          <FontAwesomeIcon
                            icon={interest.icon}
                            className="text-[#48ff00] text-xl sm:text-2xl"
                          />
                        </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-8 lg:space-y-12">
              {[
                {
                  year: "2021",
                  title: "Joined GHS Tappi Kohat",
                  desc: "Began formal education in Computer Science",
                },
                {
                  year: "2023",
                  title: "Joined GCMS college Kohat",
                  desc: "Began intermediate education in Computer Science",
                },
                {
                  year: "2025 Present",
                  title: "MERN Certification at SMIT",
                  desc: "Completed Full-Stack Developer Certification",
                },
                {
                  year: "2025 Present",
                ...
                >
                  ...
                  >
                    <div className="text-[#48ff00] font-mono text-sm sm:text-base mb-2">
                      {item.year}
                    </div>
          ...
          <div className="flex justify-center space-x-4 sm:space-x-6 md:space-x-8">
            {[
              ...
              },
              {
                ...
                url: "https://linkedin.com/rafideveloper7",
              },
              {
                icon: faTwitter,
                label: "Twitter",
                color: "hover:text-cyan-400",
                url: "https://x.com/rafideveloper7",
              },
              {
                icon: faCodepen,
                label: "CodePen",
                color: "hover:text-green-400",
                url: "https://codepen.io/rafideveloper7",
              },
            ].map((social, index) => (
              <a
                key={index}
